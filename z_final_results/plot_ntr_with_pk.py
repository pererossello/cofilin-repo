...
with h5py.File(datapath, "r") as h5_file:
    ...
    optimal_cross = np.array(h5_file["optimal_cross"][:])
...
axs[0].plot(k_c, ntr_ref_pk, c=color_ref, ls=ls_ref, lw=lw, zorder=zorder_ref, label=ref_label)
axs[0].plot(k_c, ntr_pks_mean, c=color_rec_mean, ls=ls_rec, lw=lw, zorder=zorder_rec+1, label=rec_label)
axs[0].fill_between(
    k_c,
    ntr_pks_mean - ntr_pks_std,
    ntr_pks_mean + ntr_pks_std,
    facecolor=color_rec,
    ls=ls_rec,
    lw=0.0,
...
axs[2].plot(k_c, ntr_pk_rats_mean, c=color_rec_mean, ls=ls_rec, lw=lw, zorder=zorder_rec+1)
axs[2].fill_between(
    k_c,
    ntr_pk_rats_mean - ntr_pk_rats_std,
    ntr_pk_rats_mean + ntr_pk_rats_std,
    facecolor=color_rec,
    ls=ls_rec,
    lw=0.0,
...
axs[1].plot(thetas, ntr_ref_bispec, c=color_ref, ls=ls_ref, lw=lw, zorder=zorder_ref)
axs[1].plot(thetas, ntr_bispecs_mean, c=color_rec_mean, ls=ls_rec, lw=lw, zorder=zorder_rec+1)
axs[1].fill_between(
    thetas,
    ntr_bispecs_mean - ntr_bispecs_std,
    ntr_bispecs_mean + ntr_bispecs_std,
    facecolor=color_rec,
    ls=ls_rec,
    lw=0.0,
...
axs[3].plot(thetas, ntr_bispec_rats_mean, c=color_rec_mean, ls=ls_rec, lw=lw, zorder=zorder_rec+1)
axs[3].fill_between(
    thetas,
    ntr_bispec_rats_mean - ntr_bispec_rats_std,
    ntr_bispec_rats_mean + ntr_bispec_rats_std,
    facecolor=color_rec,
    ls=ls_rec,
    lw=0.0,
...
axs[4].plot(k_c, optimal_cross, c=color_ref, ls='-.', lw=lw, zorder=zorder_rec+10, label=extra_label)
axs[4].plot(k_c, ntr_crosses_mean, c=color_rec_mean, ls=ls_rec, lw=lw, zorder=zorder_rec+1)
axs[4].fill_between(
    k_c,
    ntr_crosses_mean - ntr_crosses_std,
    ntr_crosses_mean + ntr_crosses_std,
    facecolor=color_rec,
    ls=ls_rec,
    lw=0.0,

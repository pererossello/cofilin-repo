...
rec_dir = "/home/pere/code/cofilin-repo/z_recs/phiweb_pl/N64_R14_RSD_SQ1"
...
from cofilin.forward_model.config import Constants, FMConfig, load_fm_config, serialize_dic
...
n_tr_fit = fmodel.sample_n_tr(n_tr_mean_fit, key_sample, params=bias_params, cweb=cweb_arr)
